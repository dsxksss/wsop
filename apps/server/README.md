...
（actor / action / entity / diff / ip / ua）。
...
└── routes/        health / auth / users / customers / deployments / maintenance / files
migrations/        0001..0007（全量 schema）
```
